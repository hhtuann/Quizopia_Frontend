...
function NotifIcon({ type, unread }: { type: string; unread: boolean }) {
  ...
  switch (type) {
    ...
    case "ADDED_TO_SCHOOL":
      return <svg className={common} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>;
    ...
    case "EXAM_SESSION_AVAILABLE":
      return <svg className={common} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m-6-8h6m-9-4h12a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1Z" /></svg>;
    default:
